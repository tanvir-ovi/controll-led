...
const char* password = "ovi12345";

// Set web server port number to 80
WiFiServer server(80); // create a server that will listen connections on port 80
...
// Current time
unsigned long currentTime = millis();  //Returns the number of milliseconds passed since the Arduino board began running the current program
// Previous time
